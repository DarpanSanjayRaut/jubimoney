    ...
    email: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emailStage) {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.unemployed.emailId.valid
                }
            }
            else {
                ...
                data.reply = {
                    type: 'text',
                    text: msg.marathi.unemployed.emailId.fallback
                }
            }
            return resolve(data)
        })
    ...
    mobileNo : function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.mobileStage) {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.unemployed.mobileNo.valid,
                }
            }
            else {
                console.log("----printing this-----")
                data.reply = {
                    type: 'text',
                    text: msg.marathi.unemployed.mobileNo.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            data.reply = {
                type: 'text',
                text: msg.marathi.unemployed.end.valid,
            }
            return resolve(data)
        })
    }
