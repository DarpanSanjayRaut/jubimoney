        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.dependentNoStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.dependentNo.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.dependentNo.button[0].data,
                                    text: msg.hindi.retired.dependentNo.button[0].text
                                },
                                {
                                    data: msg.english.retired.dependentNo.button[1].data,
                                    text: msg.hindi.retired.dependentNo.button[1].text
                                },
                                {
                                    data: msg.english.retired.dependentNo.button[2].data,
                                    text: msg.hindi.retired.dependentNo.button[2].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.dependentNo.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.dependentNo.button[0].data,
    ...
    pension: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.pensionStage) {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.pension.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.pension.fallback,
                }
            }
    ...
    expense: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.expenseStage) {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.expense.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.expense.fallback,
                }
            }
            return resolve(data)
        })
    ...
    emergencyFund: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emergencyFundStage) {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.emergencyFund.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.emergencyFund.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.monthlyInvestmentStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.monthlyInvestment.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.monthlyInvestment.button[0].data,
                                    text: msg.hindi.retired.monthlyInvestment.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.monthlyInvestment.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.monthlyInvestment.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.lifeInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsurance.button[0].data,
                                    text: msg.hindi.retired.lifeInsurance.button[0].text
                                },
                                {
                                    data: msg.english.retired.lifeInsurance.button[1].data,
                                    text: msg.hindi.retired.lifeInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.lifeInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.lifeInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsuranceAmt.button[0].data,
                                    text: msg.hindi.retired.lifeInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.lifeInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.healthInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsurance.button[0].data,
                                    text: msg.hindi.retired.healthInsurance.button[0].text
                                },
                                {
                                    data: msg.english.retired.healthInsurance.button[1].data,
                                    text: msg.hindi.retired.healthInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.healthInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.healthInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsuranceAmt.button[0].data,
                                    text: msg.hindi.retired.healthInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.healthInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.homeLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.homeLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.homeLoan.button[0].data,
                                    text: msg.hindi.retired.homeLoan.button[0].text
                                },
                                {
                                    data: msg.english.retired.homeLoan.button[1].data,
                                    text: msg.hindi.retired.homeLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.homeLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.homeLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.otherLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.otherLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.otherLoan.button[0].data,
                                    text: msg.hindi.retired.otherLoan.button[0].text
                                },
                                {
                                    data: msg.english.retired.otherLoan.button[1].data,
                                    text: msg.hindi.retired.otherLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.hindi.retired.otherLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.otherLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.emiStage) {
                    data.reply = {
                        type: 'text',
                        text: msg.hindi.retired.emi.valid,
                    }
                }
                else {
                    data.reply = {
                        type: 'text',
                        text: msg.hindi.retired.emi.fallback,
                    }
                }
                return resolve(data)
            }
    ...
    emailId: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emailStage) {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.emailId.valid
                }
            }
            else {
                ...
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.emailId.fallback
                }
            }
            return resolve(data)
        })
    ...
    mobileNo : function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.mobileStage) {
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.mobileNo.valid,
                }
            }
            else {
                console.log("----printing this-----")
                data.reply = {
                    type: 'text',
                    text: msg.hindi.retired.mobileNo.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            data.reply = {
                type: 'text',
                text: msg.hindi.retired.end.valid,
            }
            return resolve(data)
        })
    }
