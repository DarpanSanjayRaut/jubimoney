...
module.exports = {
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.dependentNoStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.dependentNo.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.dependentNo.button[0].data,
                                    text: msg.marathi.retired.dependentNo.button[0].text
                                },
                                {
                                    data: msg.english.retired.dependentNo.button[1].data,
                                    text: msg.marathi.retired.dependentNo.button[1].text
                                },
                                {
                                    data: msg.english.retired.dependentNo.button[2].data,
                                    text: msg.marathi.retired.dependentNo.button[2].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.dependentNo.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.dependentNo.button[0].data,
    ...
    pension: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.pensionStage) {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.pension.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.pension.fallback,
                }
            }
    ...
    expense: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.expenseStage) {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.expense.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.expense.fallback,
                }
            }
            return resolve(data)
        })
    ...
    emergencyFund: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emergencyFundStage) {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.emergencyFund.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.emergencyFund.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.monthlyInvestmentStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.monthlyInvestment.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.monthlyInvestment.button[0].data,
                                    text: msg.marathi.retired.monthlyInvestment.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.monthlyInvestment.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.monthlyInvestment.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.lifeInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsurance.button[0].data,
                                    text: msg.marathi.retired.lifeInsurance.button[0].text
                                },
                                {
                                    data: msg.english.retired.lifeInsurance.button[1].data,
                                    text: msg.marathi.retired.lifeInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.lifeInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.lifeInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsuranceAmt.button[0].data,
                                    text: msg.marathi.retired.lifeInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.lifeInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.healthInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsurance.button[0].data,
                                    text: msg.marathi.retired.healthInsurance.button[0].text
                                },
                                {
                                    data: msg.english.retired.healthInsurance.button[1].data,
                                    text: msg.marathi.retired.healthInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.healthInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.healthInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsuranceAmt.button[0].data,
                                    text: msg.marathi.retired.healthInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.healthInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.homeLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.homeLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.homeLoan.button[0].data,
                                    text: msg.marathi.retired.homeLoan.button[0].text
                                },
                                {
                                    data: msg.english.retired.homeLoan.button[1].data,
                                    text: msg.marathi.retired.homeLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.homeLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.homeLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.otherLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.otherLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.otherLoan.button[0].data,
                                    text: msg.marathi.retired.otherLoan.button[0].text
                                },
                                {
                                    data: msg.english.retired.otherLoan.button[1].data,
                                    text: msg.marathi.retired.otherLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.marathi.retired.otherLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.otherLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.emiStage) {
                    data.reply = {
                        type: 'text',
                        text: msg.marathi.retired.emi.valid,
                    }
                }
                else {
                    data.reply = {
                        type: 'text',
                        text: msg.marathi.retired.emi.fallback,
                    }
                }
                return resolve(data)
            }
    ...
    emailId: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emailStage) {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.emailId.valid
                }
            }
            else {
                ...
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.emailId.fallback
                }
            }
            return resolve(data)
        })
    ...
    //                 data.tags.marathi.termInsurance = msg.marathi.report.termInsurance.ideal
    //             }
    //             else {
    //                 data.tags.english.termInsurance = msg.english.report.termInsurance.notIdeal
    //                 data.tags.marathi.termInsurance = msg.marathi.report.termInsurance.notIdeal
    //             }
    ...
    //                 data.tags.marathi.healthInsurance = msg.marathi.report.healthInsurance.ideal
    //             }
    //             else {
    //                 data.tags.english.healthInsurance = msg.english.report.healthInsurance.notIdeal
    //                 data.tags.marathi.healthInsurance = msg.marathi.report.healthInsurance.notIdeal
    //             }
    ...
    //                 data.tags.marathi.homeloan = msg.marathi.report.homeloan.part1 + await helper.amtConverter(data.tags.homeLoanAmt.ideal) + msg.marathi.report.homeloan.part2
    //             }
    ...
    mobileNo : function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.mobileStage) {
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.mobileNo.valid,
                }
            }
            else {
                console.log("----printing this-----")
                data.reply = {
                    type: 'text',
                    text: msg.marathi.retired.mobileNo.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            data.reply = {
                type: 'text',
                text: msg.marathi.retired.end.valid,
            }
            return resolve(data)
        })
    }
