        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.dependentNoStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.dependentNo.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.dependentNo.button[0].data,
                                    text: msg.english.pBFFlow.dependentNo.button[0].text
                                },
                                {
                                    data: msg.english.pBFFlow.dependentNo.button[1].data,
                                    text: msg.english.pBFFlow.dependentNo.button[1].text
                                },
                                {
                                    data: msg.english.pBFFlow.dependentNo.button[2].data,
                                    text: msg.english.pBFFlow.dependentNo.button[2].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.dependentNo.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.dependentNo.button[0].data,
    ...
    salary: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.salaryStage) {
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.salary.valid,
                }
                console.log('-------------' + msg.english.pBFFlow.salary.valid)
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.salary.fallback,
                }
            }
    ...
    expense: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.expenseStage) {
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.expense.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.expense.fallback,
                }
            }
            return resolve(data)
        })
    ...
    emergencyFund: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emergencyFundStage) {
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.emergencyFund.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.emergencyFund.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.monthlyInvestmentStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.monthlyInvestment.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.monthlyInvestment.button[0].data,
                                    text: msg.english.pBFFlow.monthlyInvestment.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.monthlyInvestment.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.monthlyInvestment.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.lifeInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.lifeInsurance.button[0].data,
                                    text: msg.english.pBFFlow.lifeInsurance.button[0].text
                                },
                                {
                                    data: msg.english.pBFFlow.lifeInsurance.button[1].data,
                                    text: msg.english.pBFFlow.lifeInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.lifeInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.lifeInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.lifeInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.lifeInsuranceAmt.button[0].data,
                                    text: msg.english.pBFFlow.lifeInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.lifeInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.lifeInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.healthInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.healthInsurance.button[0].data,
                                    text: msg.english.pBFFlow.healthInsurance.button[0].text
                                },
                                {
                                    data: msg.english.pBFFlow.healthInsurance.button[1].data,
                                    text: msg.english.pBFFlow.healthInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.healthInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.healthInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.healthInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.healthInsuranceAmt.button[0].data,
                                    text: msg.english.pBFFlow.healthInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.healthInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.healthInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.homeLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.homeLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.homeLoan.button[0].data,
                                    text: msg.english.pBFFlow.homeLoan.button[0].text
                                },
                                {
                                    data: msg.english.pBFFlow.homeLoan.button[1].data,
                                    text: msg.english.pBFFlow.homeLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.homeLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.homeLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.otherLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.otherLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.otherLoan.button[0].data,
                                    text: msg.english.pBFFlow.otherLoan.button[0].text
                                },
                                {
                                    data: msg.english.pBFFlow.otherLoan.button[1].data,
                                    text: msg.english.pBFFlow.otherLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.english.pBFFlow.otherLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.pBFFlow.otherLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.emiStage) {
                    data.reply = {
                        type: 'text',
                        text: msg.english.pBFFlow.emi.valid,
                    }
                }
                else {
                    data.reply = {
                        type: 'text',
                        text: msg.english.pBFFlow.emi.fallback,
                    }
                }
                return resolve(data)
            }
    ...
    phoneNo: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.phoneStage) {
                data.reply = {
                    type: 'quickReply',
                    text: msg.english.pBFFlow.phoneNo.valid,
                    next: {
                        data: [
                            {
                                data: msg.english.pBFFlow.phoneNo.button[0].data,
                                text: msg.english.pBFFlow.phoneNo.button[0].text
                            }
                        ]
                    }
                }
                ...
                data.reply = {
                    type: 'quickReply',
                    text: msg.english.pBFFlow.phoneNo.fallback,
                    next: {
                        data: [
                            {
                                data: msg.english.pBFFlow.phoneNo.button[0].data,
    ...
    mobileNo: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.mobileStage) {
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.mobileNo.valid,
                }
            }
            else {
                console.log("----printing this-----")
                data.reply = {
                    type: 'text',
                    text: msg.english.pBFFlow.mobileNo.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            data.reply = {
                type: 'text',
                text: msg.english.pBFFlow.end.valid,
            }
            return resolve(data)
        })
    }
