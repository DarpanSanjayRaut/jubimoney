        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.dependentNoStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.dependentNo.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.dependentNo.button[0].data,
                                    text: msg.kannada.salaried.dependentNo.button[0].text
                                },
                                {
                                    data: msg.hindi.salaried.dependentNo.button[1].data,
                                    text: msg.kannada.salaried.dependentNo.button[1].text
                                },
                                {
                                    data: msg.hindi.salaried.dependentNo.button[2].data,
                                    text: msg.kannada.salaried.dependentNo.button[2].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.dependentNo.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.dependentNo.button[0].data,
    ...
    salary: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.salaryStage) {
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.salary.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.salary.fallback,
                }
            }
    ...
    expense: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.expenseStage) {
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.expense.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.expense.fallback,
                }
            }
            return resolve(data)
        })
    ...
    emergencyFund: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emergencyFundStage) {
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.emergencyFund.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.emergencyFund.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.monthlyInvestmentStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.monthlyInvestment.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.monthlyInvestment.button[0].data,
                                    text: msg.kannada.salaried.monthlyInvestment.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.monthlyInvestment.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.monthlyInvestment.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.lifeInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.lifeInsurance.button[0].data,
                                    text: msg.kannada.salaried.lifeInsurance.button[0].text
                                },
                                {
                                    data: msg.hindi.salaried.lifeInsurance.button[1].data,
                                    text: msg.kannada.salaried.lifeInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.lifeInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.lifeInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.lifeInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.lifeInsuranceAmt.button[0].data,
                                    text: msg.kannada.salaried.lifeInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.lifeInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.lifeInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.healthInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.healthInsurance.button[0].data,
                                    text: msg.kannada.salaried.healthInsurance.button[0].text
                                },
                                {
                                    data: msg.hindi.salaried.healthInsurance.button[1].data,
                                    text: msg.kannada.salaried.healthInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.healthInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.healthInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.healthInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.healthInsuranceAmt.button[0].data,
                                    text: msg.kannada.salaried.healthInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.healthInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.healthInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.homeLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.homeLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.homeLoan.button[0].data,
                                    text: msg.kannada.salaried.homeLoan.button[0].text
                                },
                                {
                                    data: msg.hindi.salaried.homeLoan.button[1].data,
                                    text: msg.kannada.salaried.homeLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.homeLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.homeLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.otherLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.otherLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.otherLoan.button[0].data,
                                    text: msg.kannada.salaried.otherLoan.button[0].text
                                },
                                {
                                    data: msg.hindi.salaried.otherLoan.button[1].data,
                                    text: msg.kannada.salaried.otherLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.kannada.salaried.otherLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.hindi.salaried.otherLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.emiStage) {
                    data.reply = {
                        type: 'text',
                        text: msg.kannada.salaried.emi.valid,
                    }
                }
                else {
                    data.reply = {
                        type: 'text',
                        text: msg.kannada.salaried.emi.fallback,
                    }
                }
                return resolve(data)
            }
    ...
    phoneNo: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.phoneStage) {
                data.reply = {
                    type: 'quickReply',
                    text: msg.kannada.salaried.phoneNo.valid,
                    next: {
                        data: [
                            {
                                data: msg.hindi.salaried.phoneNo.button[0].data,
                                text: msg.kannada.salaried.phoneNo.button[0].text
                            }
                        ]
                    }
                }
                ...
                data.reply = {
                    type: 'quickReply',
                    text: msg.kannada.salaried.phoneNo.fallback,
                    next: {
                        data: [
                            {
                                data: msg.hindi.salaried.phoneNo.button[0].data,
    ...
    mobileNo: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.mobileStage) {
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.mobileNo.valid,
                }
            }
            else {
                console.log("----printing this-----")
                data.reply = {
                    type: 'text',
                    text: msg.kannada.salaried.mobileNo.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            data.reply = {
                type: 'text',
                text: msg.kannada.salaried.end.valid,
            }
            return resolve(data)
        })
    }
