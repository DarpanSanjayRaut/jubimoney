...
module.exports = {
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.dependentNoStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.dependentNo.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.dependentNo.button[0].data,
                                    text: msg.tamil.retired.dependentNo.button[0].text
                                },
                                {
                                    data: msg.english.retired.dependentNo.button[1].data,
                                    text: msg.tamil.retired.dependentNo.button[1].text
                                },
                                {
                                    data: msg.english.retired.dependentNo.button[2].data,
                                    text: msg.tamil.retired.dependentNo.button[2].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.dependentNo.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.dependentNo.button[0].data,
    ...
    pension: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.pensionStage) {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.pension.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.pension.fallback,
                }
            }
    ...
    expense: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.expenseStage) {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.expense.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.expense.fallback,
                }
            }
            return resolve(data)
        })
    ...
    emergencyFund: function (data) {
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emergencyFundStage) {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.emergencyFund.valid,
                }
            }
            else {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.emergencyFund.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.monthlyInvestmentStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.monthlyInvestment.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.monthlyInvestment.button[0].data,
                                    text: msg.tamil.retired.monthlyInvestment.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.monthlyInvestment.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.monthlyInvestment.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.lifeInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsurance.button[0].data,
                                    text: msg.tamil.retired.lifeInsurance.button[0].text
                                },
                                {
                                    data: msg.english.retired.lifeInsurance.button[1].data,
                                    text: msg.tamil.retired.lifeInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.lifeInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.lifeInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.lifeInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsuranceAmt.button[0].data,
                                    text: msg.tamil.retired.lifeInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.lifeInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.lifeInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.healthInsurance.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsurance.button[0].data,
                                    text: msg.tamil.retired.healthInsurance.button[0].text
                                },
                                {
                                    data: msg.english.retired.healthInsurance.button[1].data,
                                    text: msg.tamil.retired.healthInsurance.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.healthInsurance.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsurance.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.healthInsuranceAmtStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.healthInsuranceAmt.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsuranceAmt.button[0].data,
                                    text: msg.tamil.retired.healthInsuranceAmt.button[0].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.healthInsuranceAmt.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.healthInsuranceAmt.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.homeLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.homeLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.homeLoan.button[0].data,
                                    text: msg.tamil.retired.homeLoan.button[0].text
                                },
                                {
                                    data: msg.english.retired.homeLoan.button[1].data,
                                    text: msg.tamil.retired.homeLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.homeLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.homeLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.otherLoanStage) {
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.otherLoan.valid,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.otherLoan.button[0].data,
                                    text: msg.tamil.retired.otherLoan.button[0].text
                                },
                                {
                                    data: msg.english.retired.otherLoan.button[1].data,
                                    text: msg.tamil.retired.otherLoan.button[1].text
                                }
                            ]
                        }
                    }
                    ...
                    data.reply = {
                        type: 'quickReply',
                        text: msg.tamil.retired.otherLoan.fallback,
                        next: {
                            data: [
                                {
                                    data: msg.english.retired.otherLoan.button[0].data,
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (data && data.tags && !data.tags.emiStage) {
                    data.reply = {
                        type: 'text',
                        text: msg.tamil.retired.emi.valid,
                    }
                }
                else {
                    data.reply = {
                        type: 'text',
                        text: msg.tamil.retired.emi.fallback,
                    }
                }
                return resolve(data)
            }
    ...
    emailId: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.emailStage) {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.emailId.valid
                }
            }
            else {
                ...
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.emailId.fallback
                }
            }
            return resolve(data)
        })
    ...
    //                 data.tags.tamil.termInsurance = msg.tamil.report.termInsurance.ideal
    //             }
    //             else {
    //                 data.tags.english.termInsurance = msg.english.report.termInsurance.notIdeal
    //                 data.tags.tamil.termInsurance = msg.tamil.report.termInsurance.notIdeal
    //             }
    ...
    //                 data.tags.tamil.healthInsurance = msg.tamil.report.healthInsurance.ideal
    //             }
    //             else {
    //                 data.tags.english.healthInsurance = msg.english.report.healthInsurance.notIdeal
    //                 data.tags.tamil.healthInsurance = msg.tamil.report.healthInsurance.notIdeal
    //             }
    ...
    //                 data.tags.tamil.homeloan = msg.tamil.report.homeloan.part1 + await helper.amtConverter(data.tags.homeLoanAmt.ideal) + msg.tamil.report.homeloan.part2
    //             }
    ...
    mobileNo : function (data) {
        ...
        return new Promise(function (resolve, reject) {
            if (data && data.tags && !data.tags.mobileStage) {
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.mobileNo.valid,
                }
            }
            else {
                console.log("----printing this-----")
                data.reply = {
                    type: 'text',
                    text: msg.tamil.retired.mobileNo.fallback,
                }
            }
            return resolve(data)
        })
        ...
        return new Promise(function (resolve, reject) {
            data.reply = {
                type: 'text',
                text: msg.tamil.retired.end.valid,
            }
            return resolve(data)
        })
    }
